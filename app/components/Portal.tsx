...
interface Props { title: string; subtitle: string; data: PortalData; accentColor?: string; showPTO?: boolean }
...
export default function Portal({ title, subtitle, data, accentColor = '#16635C', showPTO = false }: Props) {
  ...
  const [view, setView] = useState<'docs' | 'pto' | 'files'>('docs');
